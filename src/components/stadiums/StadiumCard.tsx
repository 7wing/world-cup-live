...
export const StadiumCard = memo(function StadiumCard({ stadium, onSelect }: StadiumCardProps) {
  return (
    <article
    ...
    >
      <div className="relative h-44 overflow-hidden bg-[#282a2b]">
        ...
        <div className="absolute bottom-3 left-3 right-3">
          <h3 className="font-lexend font-black uppercase text-base leading-tight text-white">{stadium.name}</h3>
