...
const GROUPS_2022: GroupMap = {
  ...
  G: [
    ...
    { code: 'CM', team: 'Cameroon',    played: 3, won: 1, drawn: 1, lost: 1, gf: 4, ga: 4, gd:  0, pts: 4 },
    { code: 'RS', team: 'Serbia',      played: 3, won: 0, drawn: 1, lost: 2, gf: 5, ga: 8, gd: -3, pts: 1 },
  ],
  H: [
    { code: 'PT', team: 'Portugal',    played: 3, won: 2, drawn: 0, lost: 1, gf: 6, ga: 4, gd:  2, pts: 6, qualified: true },
    { code: 'KR', team: 'South Korea', played: 3, won: 1, drawn: 1, lost: 1, gf: 4, ga: 4, gd:  0, pts: 4, qualified: true },
    { code: 'UY', team: 'Uruguay',     played: 3, won: 1, drawn: 1, lost: 1, gf: 2, ga: 2, gd:  0, pts: 4 },
    { code: 'GH', team: 'Ghana',       played: 3, won: 1, drawn: 0, lost: 2, gf: 5, ga: 7, gd: -2, pts: 3 },
  ],
}

// ── 2026 Groups (official FIFA draw, December 2025) ───────────────────────────
